package io.github.jtsato.moviescatalog.entrypoint.rest.common.metric;
...
public class LogExecutionTimeImpl {
    ...
    @SneakyThrows
    @Around("@annotation(io.github.jtsato.moviescatalog.entrypoint.rest.common.metric.LogExecutionTime)")
